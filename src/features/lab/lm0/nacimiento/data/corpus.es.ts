/**
 * corpus.es — what the baby machine reads in Spanish: the opening chapters of Don Quijote.
...
export const corpusEs: Corpus = {
  attribution: "Miguel de Cervantes — Don Quijote de la Mancha (1605). Proyecto Gutenberg #2000.",
  memorizedPhrase: "de cuyo nombre no quiero acordarme",
  raw: `En un lugar de la Mancha, de cuyo nombre no quiero acordarme, no ha mucho
