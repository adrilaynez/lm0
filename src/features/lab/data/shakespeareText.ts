/* Real tinyShakespeare excerpt (public domain, ~300 KB). Scanned LIVE by the counting showpiece
   and shown literally — capitals, names, punctuation — so the reader sees it IS Shakespeare.
   Counting normalizes to [a-z + space] under the hood; the display keeps the literal text. */

export const SHAKESPEARE_TEXT = `First Citizen:
