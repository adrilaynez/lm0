...
/**
 * HonestBar — a single fixed-axis probability bar row for the Bigram chapter (v8, editorial-green).
 *
 ...
 *
 * Reads only --bigram-* tokens + the registered font vars; gated by the consumer's [data-bigram-theme]
...
export const HonestBar = memo(function HonestBar({
    ...
    return (
        ...
        >
            ...
            >
                <span style={{ color: "var(--bigram-dim)", fontWeight: 500 }}>{srcGlyph}</span>
                <span
                    style={{
            ...
            >
                <motion.span
                    ...
                    style={{
                        ...
                        background: top ? "var(--bigram-accent-bright)" : "var(--bigram-accent-2)",
                    }}
                >
                    {runGlint && (
                        <motion.span
