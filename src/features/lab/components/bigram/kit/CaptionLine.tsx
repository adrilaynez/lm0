...
/**
 * bigram/kit · CaptionLine — the mono uppercase eyebrow that labels a widget ("INTERACTIVO · …",
 * "LA MÁQUINA LEE"). Duplicated in FillTheBlank/IsolateT/RowTally as `.bw-*__label`/`__eyebrow`.
 *
