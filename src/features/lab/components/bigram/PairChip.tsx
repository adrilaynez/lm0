...
/**
 * PairChip — the pair pill for the Bigram chapter (v8, editorial-green).
 *
 ...
 * to --bigram-accent-soft with an inset accent ring and the disc fills accent / on-accent — so the
 * pattern *pops* the moment language starts repeating itself. One idea, shown by fill not chrome.
 *
 * Reads only --bigram-* tokens + the registered mono font. Reduced-motion safe.
 * Mirrors styles-v8.css `.bw-pairs__pair` / `.bw-pairs__pair.rep`.
 */
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span
                    style={{
                        color: repeated ? "var(--bigram-accent-ink)" : "var(--bigram-ink)",
            ...
            <span
                style={{
                    ...
                    fontSize: "12.5px",
                    fontWeight: 700,
                    color: repeated ? "var(--bigram-on-accent)" : "var(--bigram-dim)",
