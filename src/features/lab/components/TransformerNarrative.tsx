...
const DotProductQuiz = lazy(() => import("@/features/lab/components/transformer/DotProductQuiz").then((m) => ({ default: m.DotProductQuiz })));
...
const QueryKeyRelationsViz = lazy(() => import("@/features/lab/components/transformer/QueryKeyRelationsViz").then((m) => ({ default: m.QueryKeyRelationsViz })));
...
const DepthVsQualityViz = lazy(() => import("@/features/lab/components/transformer/DepthVsQualityViz").then((m) => ({ default: m.DepthVsQualityViz })));
...
const ArchitectureTowerViz = lazy(() => import("@/features/lab/components/transformer/ArchitectureTowerViz").then((m) => ({ default: m.ArchitectureTowerViz })));
...
const BlockBlueprintViz = lazy(() => import("@/features/lab/components/transformer/BlockBlueprintViz").then((m) => ({ default: m.BlockBlueprintViz })));
