...
const WordToEmbeddingViz = lazy(() => import("@/features/lab/components/transformer/WordToEmbeddingViz").then((m) => ({ default: m.WordToEmbeddingViz })));
const PronounResolutionViz = lazy(() => import("@/features/lab/components/transformer/PronounResolutionViz").then((m) => ({ default: m.PronounResolutionViz })));
const DrawConnectionsViz = lazy(() => import("@/features/lab/components/transformer/DrawConnectionsViz").then((m) => ({ default: m.DrawConnectionsViz })));
const WishlistCallbackViz = lazy(() => import("@/features/lab/components/transformer/WishlistCallbackViz").then((m) => ({ default: m.WishlistCallbackViz })));
const FrozenVsContextualViz = lazy(() => import("@/features/lab/components/transformer/FrozenVsContextualViz").then((m) => ({ default: m.FrozenVsContextualViz })));
const ContextEnrichmentViz = lazy(() => import("@/features/lab/components/transformer/ContextEnrichmentViz").then((m) => ({ default: m.ContextEnrichmentViz })));

/* ─── Lazy-loaded visualizers: §02 ─── */
const TelephoneGameViz = lazy(() => import("@/features/lab/components/transformer/TelephoneGameViz").then((m) => ({ default: m.TelephoneGameViz })));
const LSTMBandageViz = lazy(() => import("@/features/lab/components/transformer/LSTMBandageViz").then((m) => ({ default: m.LSTMBandageViz })));
const SequentialVsParallelViz = lazy(() => import("@/features/lab/components/transformer/SequentialVsParallelViz").then((m) => ({ default: m.SequentialVsParallelViz })));
const RNNChainViz = lazy(() => import("@/features/lab/components/transformer/RNNChainViz").then((m) => ({ default: m.RNNChainViz })));

/* ─── Lazy-loaded visualizers: §03 ─── */
const SpotlightViz = lazy(() => import("@/features/lab/components/transformer/SpotlightViz").then((m) => ({ default: m.SpotlightViz })));
const GuessPatternViz = lazy(() => import("@/features/lab/components/transformer/GuessPatternViz").then((m) => ({ default: m.GuessPatternViz })));
const StaticVsDynamicViz = lazy(() => import("@/features/lab/components/transformer/StaticVsDynamicViz").then((m) => ({ default: m.StaticVsDynamicViz })));
const AttentionHeatmapViz = lazy(() => import("@/features/lab/components/transformer/AttentionHeatmapViz").then((m) => ({ default: m.AttentionHeatmapViz })));
const AttentionWebViz = lazy(() => import("@/features/lab/components/transformer/AttentionWebViz").then((m) => ({ default: m.AttentionWebViz })));

/* ─── Lazy-loaded visualizers: §04a ─── */
const EmbeddingToArrowViz = lazy(() => import("@/features/lab/components/transformer/EmbeddingToArrowViz").then((m) => ({ default: m.EmbeddingToArrowViz })));
const DotProductCalculatorViz = lazy(() => import("@/features/lab/components/transformer/DotProductCalculatorViz").then((m) => ({ default: m.DotProductCalculatorViz })));
const PairwiseScoringViz = lazy(() => import("@/features/lab/components/transformer/PairwiseScoringViz").then((m) => ({ default: m.PairwiseScoringViz })));
const SelfSimilarityViz = lazy(() => import("@/features/lab/components/transformer/SelfSimilarityViz").then((m) => ({ default: m.SelfSimilarityViz })));
const EmbeddingAttentionFailureViz = lazy(() => import("@/features/lab/components/transformer/EmbeddingAttentionFailureViz").then((m) => ({ default: m.EmbeddingAttentionFailureViz })));

/* ─── Lazy-loaded visualizers: §04b-c ─── */
const QKSplitViz = lazy(() => import("@/features/lab/components/transformer/QKSplitViz").then((m) => ({ default: m.QKSplitViz })));
const QKMatrixViz = lazy(() => import("@/features/lab/components/transformer/QKMatrixViz").then((m) => ({ default: m.QKMatrixViz })));
const QuerySearchViz = lazy(() => import("@/features/lab/components/transformer/QuerySearchViz").then((m) => ({ default: m.QuerySearchViz })));
const WhyQKMattersViz = lazy(() => import("@/features/lab/components/transformer/WhyQKMattersViz").then((m) => ({ default: m.WhyQKMattersViz })));
const WeightsOfWhatViz = lazy(() => import("@/features/lab/components/transformer/WeightsOfWhatViz").then((m) => ({ default: m.WeightsOfWhatViz })));
const ValueCompletesViz = lazy(() => import("@/features/lab/components/transformer/ValueCompletesViz").then((m) => ({ default: m.ValueCompletesViz })));
const BeforeAfterAttentionViz = lazy(() => import("@/features/lab/components/transformer/BeforeAfterAttentionViz").then((m) => ({ default: m.BeforeAfterAttentionViz })));

/* ─── Lazy-loaded visualizers: §04d ─── */
const NumbersExplodeViz = lazy(() => import("@/features/lab/components/transformer/NumbersExplodeViz").then((m) => ({ default: m.NumbersExplodeViz })));
const ScalingFixViz = lazy(() => import("@/features/lab/components/transformer/ScalingFixViz").then((m) => ({ default: m.ScalingFixViz })));
const FullScoringPipelineViz = lazy(() => import("@/features/lab/components/transformer/FullScoringPipelineViz").then((m) => ({ default: m.FullScoringPipelineViz })));
const ContextAssemblyFilmViz = lazy(() => import("@/features/lab/components/transformer/ContextAssemblyFilmViz").then((m) => ({ default: m.ContextAssemblyFilmViz })));
const FullContextualAssemblyViz = lazy(() => import("@/features/lab/components/transformer/FullContextualAssemblyViz").then((m) => ({ default: m.FullContextualAssemblyViz })));

/* ─── Lazy-loaded visualizers: §05 ─── */
const WhichWordMattersViz = lazy(() => import("@/features/lab/components/transformer/WhichWordMattersViz").then((m) => ({ default: m.WhichWordMattersViz })));
const OneHeadDilemmaViz = lazy(() => import("@/features/lab/components/transformer/OneHeadDilemmaViz").then((m) => ({ default: m.OneHeadDilemmaViz })));
const MultiHeadIdeaViz = lazy(() => import("@/features/lab/components/transformer/MultiHeadIdeaViz").then((m) => ({ default: m.MultiHeadIdeaViz })));
const MultiLensViewViz = lazy(() => import("@/features/lab/components/transformer/MultiLensViewViz").then((m) => ({ default: m.MultiLensViewViz })));
const HeadBudgetViz = lazy(() => import("@/features/lab/components/transformer/HeadBudgetViz").then((m) => ({ default: m.HeadBudgetViz })));
const MultiHeadPipelineViz = lazy(() => import("@/features/lab/components/transformer/MultiHeadPipelineViz").then((m) => ({ default: m.MultiHeadPipelineViz })));

/* ─── Lazy-loaded visualizers: §06 ─── */
const ShuffleDisasterViz = lazy(() => import("@/features/lab/components/transformer/ShuffleDisasterViz").then((m) => ({ default: m.ShuffleDisasterViz })));
const SimpleNumbersViz = lazy(() => import("@/features/lab/components/transformer/SimpleNumbersViz").then((m) => ({ default: m.SimpleNumbersViz })));
const LearnedPositionEmbeddingsViz = lazy(() => import("@/features/lab/components/transformer/LearnedPositionEmbeddingsViz").then((m) => ({ default: m.LearnedPositionEmbeddingsViz })));
const WaveFingerprintViz = lazy(() => import("@/features/lab/components/transformer/WaveFingerprintViz").then((m) => ({ default: m.WaveFingerprintViz })));
const PositionalSimilarityViz = lazy(() => import("@/features/lab/components/transformer/PositionalSimilarityViz").then((m) => ({ default: m.PositionalSimilarityViz })));
const AddEmbeddingsViz = lazy(() => import("@/features/lab/components/transformer/AddEmbeddingsViz").then((m) => ({ default: m.AddEmbeddingsViz })));
const PositionInActionViz = lazy(() => import("@/features/lab/components/transformer/PositionInActionViz").then((m) => ({ default: m.PositionInActionViz })));

/* ─── Lazy-loaded visualizers: §07 ─── */
const CommunicationVsProcessingViz = lazy(() => import("@/features/lab/components/transformer/CommunicationVsProcessingViz").then((m) => ({ default: m.CommunicationVsProcessingViz })));
const FFNCallbackViz = lazy(() => import("@/features/lab/components/transformer/FFNCallbackViz").then((m) => ({ default: m.FFNCallbackViz })));
const FFNDeepDiveViz = lazy(() => import("@/features/lab/components/transformer/FFNDeepDiveViz").then((m) => ({ default: m.FFNDeepDiveViz })));
const HighwayReturnsViz = lazy(() => import("@/features/lab/components/transformer/HighwayReturnsViz").then((m) => ({ default: m.HighwayReturnsViz })));
const LayerNormViz = lazy(() => import("@/features/lab/components/transformer/LayerNormViz").then((m) => ({ default: m.LayerNormViz })));
const ValueDriftViz = lazy(() => import("@/features/lab/components/transformer/ValueDriftViz").then((m) => ({ default: m.ValueDriftViz })));
const BatchVsLayerNormViz = lazy(() => import("@/features/lab/components/transformer/BatchVsLayerNormViz").then((m) => ({ default: m.BatchVsLayerNormViz })));
const BlockBuilderViz = lazy(() => import("@/features/lab/components/transformer/BlockBuilderViz").then((m) => ({ default: m.BlockBuilderViz })));
const BlockComponentExplorerViz = lazy(() => import("@/features/lab/components/transformer/BlockComponentExplorerViz").then((m) => ({ default: m.BlockComponentExplorerViz })));
const QKVProjectionViz = lazy(() => import("@/features/lab/components/transformer/QKVProjectionViz").then((m) => ({ default: m.QKVProjectionViz })));
const AttentionScoreViz = lazy(() => import("@/features/lab/components/transformer/AttentionScoreViz").then((m) => ({ default: m.AttentionScoreViz })));
const TransformerBlockExplorerViz = lazy(() => import("@/features/lab/components/transformer/TransformerBlockExplorerViz").then((m) => ({ default: m.TransformerBlockExplorerViz })));
const AttentionAloneFailsViz = lazy(() => import("@/features/lab/components/transformer/AttentionAloneFailsViz").then((m) => ({ default: m.AttentionAloneFailsViz })));
const LayerEvolutionViz = lazy(() => import("@/features/lab/components/transformer/LayerEvolutionViz").then((m) => ({ default: m.LayerEvolutionViz })));
const LinearSoftmaxViz = lazy(() => import("@/features/lab/components/transformer/LinearSoftmaxViz").then((m) => ({ default: m.LinearSoftmaxViz })));

/* ─── Lazy-loaded visualizers: §08 ─── */
const UntrainedOutputViz = lazy(() => import("@/features/lab/components/transformer/UntrainedOutputViz").then((m) => ({ default: m.UntrainedOutputViz })));
const ParallelPredictionViz = lazy(() => import("@/features/lab/components/transformer/ParallelPredictionViz").then((m) => ({ default: m.ParallelPredictionViz })));
const TrainingTimelapseViz = lazy(() => import("@/features/lab/components/transformer/TrainingTimelapseViz").then((m) => ({ default: m.TrainingTimelapseViz })));
const ModelBattleArena = lazy(() => import("@/features/lab/components/transformer/ModelBattleArena").then((m) => ({ default: m.ModelBattleArena })));
const NeuronScalingViz = lazy(() => import("@/features/lab/components/transformer/NeuronScalingViz").then((m) => ({ default: m.NeuronScalingViz })));
const CausalMaskViz = lazy(() => import("@/features/lab/components/transformer/CausalMaskViz").then((m) => ({ default: m.CausalMaskViz })));
const CharGenerationPlayground = lazy(() => import("@/features/lab/components/transformer/CharGenerationPlayground").then((m) => ({ default: m.CharGenerationPlayground })));

/* ─── Lazy-loaded visualizers: §09 ─── */
const DepthBreakthroughViz = lazy(() => import("@/features/lab/components/transformer/DepthBreakthroughViz").then((m) => ({ default: m.DepthBreakthroughViz })));
const LayerLensViz = lazy(() => import("@/features/lab/components/transformer/LayerLensViz").then((m) => ({ default: m.LayerLensViz })));
const DepthGenerationViz = lazy(() => import("@/features/lab/components/transformer/DepthGenerationViz").then((m) => ({ default: m.DepthGenerationViz })));
const OverfittingDualCurveViz = lazy(() => import("@/features/lab/components/transformer/OverfittingDualCurveViz").then((m) => ({ default: m.OverfittingDualCurveViz })));
const MemorizationRevealViz = lazy(() => import("@/features/lab/components/transformer/MemorizationRevealViz").then((m) => ({ default: m.MemorizationRevealViz })));
const ContextWindowViz = lazy(() => import("@/features/lab/components/transformer/ContextWindowViz").then((m) => ({ default: m.ContextWindowViz })));

/* ─── Lazy-loaded visualizers: §10 ─── */
const CharVsTokenViz = lazy(() => import("@/features/lab/components/transformer/CharVsTokenViz").then((m) => ({ default: m.CharVsTokenViz })));
const EvolutionTimelineViz = lazy(() => import("@/features/lab/components/transformer/EvolutionTimelineViz").then((m) => ({ default: m.EvolutionTimelineViz })));
const ArchitectureIdentityViz = lazy(() => import("@/features/lab/components/transformer/ArchitectureIdentityViz").then((m) => ({ default: m.ArchitectureIdentityViz })));
const CompletionVsAssistantViz = lazy(() => import("@/features/lab/components/transformer/CompletionVsAssistantViz").then((m) => ({ default: m.CompletionVsAssistantViz })));
const ThreeMysteriesViz = lazy(() => import("@/features/lab/components/transformer/ThreeMysteriesViz").then((m) => ({ default: m.ThreeMysteriesViz })));
const ConceptRecallViz = lazy(() => import("@/features/lab/components/transformer/ConceptRecallViz").then((m) => ({ default: m.ConceptRecallViz })));
const ShareJourneyViz = lazy(() => import("@/features/lab/components/transformer/ShareJourneyViz").then((m) => ({ default: m.ShareJourneyViz })));
...
const CALLOUT_ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
    AlertTriangle, Brain, Layers, Sparkles, Zap,
};

/* Callout that keeps the chapter's icon + accent overrides. */
const Callout = ({ icon, accent, title, children }: { icon?: string; accent?: NarrativeAccent | "indigo"; title?: string; children?: React.ReactNode }) => (
    <_Callout icon={icon ? CALLOUT_ICONS[icon] : undefined} accent={accent ?? NA} title={title}>{children}</_Callout>
);

/* KeyTakeaway bound to cyan. */
const KeyTakeaway = ({ accent, children }: { accent?: NarrativeAccent; children?: React.ReactNode }) => (
...
const PullQuote = (p: { children?: React.ReactNode }) => <_PullQuote accent={NA}>{p.children}</_PullQuote>;
...
const Highlight = ({ color, ...p }: { children?: React.ReactNode; color?: HighlightColor; tooltip?: string }) => {
    ...
    if (p.tooltip) return <_Highlight color={c} tooltip={p.tooltip}>{p.children}</_Highlight>;
    return (
        <strong
...
const GradientText = ({ children, from = "from-cyan-300", via, to = "to-teal-300" }: { children?: React.ReactNode; from?: string; via?: string; to?: string }) => (
    <strong className={`font-semibold bg-gradient-to-r ${from} ${via ?? ""} ${to} bg-clip-text text-transparent`}>{children}</strong>
);
...
const Math = ({ children }: { children?: React.ReactNode }) => <BlockMath math={String(children)} />;
    ...
    <div className="max-w-lg mx-auto my-8 sm:my-10">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
            {[
                ...
                >
                    <p className="text-[9px] sm:text-[10px] uppercase tracking-[0.15em] font-semibold mb-0.5" style={{ color: `rgba(${item.color},0.85)` }}>
                        {item.icon} {item.label}
                    </p>
                    <p className="text-[10px] sm:text-[11px] italic leading-snug" style={{ color: `rgba(${item.color},0.55)` }}>
                        &quot;{item.subtitle}&quot;
                    </p>
                </div>
            ))}
    ...
    <div className="my-6 max-w-md mx-auto grid grid-cols-2 gap-2.5">
        {[
            ...
            <motion.div
                ...
                style={{ background: `rgba(${item.rgb}, 0.04)`, border: `1px solid rgba(${item.rgb}, 0.12)` }}
...
const TF_WIDGETS = {
    /* §01 */
    WordToEmbeddingViz, PronounResolutionViz, DrawConnectionsViz, WishlistCallbackViz, FrozenVsContextualViz, ContextEnrichmentViz,
    /* §02 */
    TelephoneGameViz, LSTMBandageViz, SequentialVsParallelViz, RNNChainViz,
    /* §03 */
    SpotlightViz, GuessPatternViz, StaticVsDynamicViz, AttentionHeatmapViz, AttentionWebViz,
    /* §04a */
    EmbeddingToArrowViz, DotProductCalculatorViz, PairwiseScoringViz, SelfSimilarityViz, EmbeddingAttentionFailureViz,
    /* §04b-c */
    QKSplitViz, QKMatrixViz, QuerySearchViz, WhyQKMattersViz, WeightsOfWhatViz, ValueCompletesViz, BeforeAfterAttentionViz,
    /* §04d */
    NumbersExplodeViz, ScalingFixViz, FullScoringPipelineViz, ContextAssemblyFilmViz, FullContextualAssemblyViz,
    /* §05 */
    WhichWordMattersViz, OneHeadDilemmaViz, MultiHeadIdeaViz, MultiLensViewViz, HeadBudgetViz, MultiHeadPipelineViz,
    /* §06 */
    ShuffleDisasterViz, SimpleNumbersViz, LearnedPositionEmbeddingsViz, WaveFingerprintViz, PositionalSimilarityViz, AddEmbeddingsViz, PositionInActionViz,
    /* §07 */
    CommunicationVsProcessingViz, FFNCallbackViz, FFNDeepDiveViz, HighwayReturnsViz, LayerNormViz, ValueDriftViz,
    BlockBuilderViz, BlockComponentExplorerViz, TransformerBlockExplorerViz, AttentionAloneFailsViz,
    LayerEvolutionViz, LinearSoftmaxViz,
    /* §08 */
    UntrainedOutputViz, ParallelPredictionViz, TrainingTimelapseViz, ModelBattleArena, NeuronScalingViz, CausalMaskViz, CharGenerationPlayground,
    /* §09 */
    DepthBreakthroughViz, LayerLensViz, DepthGenerationViz, OverfittingDualCurveViz, MemorizationRevealViz, ContextWindowViz,
    /* §10 */
    CharVsTokenViz, EvolutionTimelineViz, ArchitectureIdentityViz, CompletionVsAssistantViz, ThreeMysteriesViz, ConceptRecallViz, ShareJourneyViz,

    /* editorial primitives (override factory defaults to keep icon/accent/glow) */
    Callout, KeyTakeaway, FormulaBlock, PullQuote, Highlight,

    /* bespoke text + layout blocks */
    GradientText, NarrativeDivider, StyledArrow, Math, MonsterStatus, MonsterInterlude,
    BigWord, BigQuestion, OptionalContextBadge, GuessPatternChallenge, QKVCards,
    BatchVsLayerNormDetails, BlockComponentsGrid, MonsterAssembly, FullMathPanel,
