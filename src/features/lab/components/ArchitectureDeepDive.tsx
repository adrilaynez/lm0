...
import { BlockMath, InlineMath } from "@/components/math/LazyMath";
      ...
      {open && (
        ...
        >
          ...
          >
            <span
              aria-hidden
              style={{ height: 6, width: 6, borderRadius: 999, background: "var(--bigram-accent)" }}
            />
            {title}
          </span>
          <span
          ...
          <ol style={{ listStyle: "none", margin: 0, padding: 0 }}>
            {STEP_DEFS.map((step, i) => (
              <li key={step.id} style={{ display: "flex", gap: 22, alignItems: "stretch" }}>
                ...
                <div
                  style={{ minWidth: 0, flex: 1, paddingBottom: i < STEP_DEFS.length - 1 ? 30 : 0 }}
                >
                  <div
                    style={{
                      display: "flex",
        ...
        >
          ...
          >
            <div>
              ...
              <dd style={{ margin: 0, fontFamily: MONO, fontSize: 15, color: "var(--bigram-ink)" }}>
                {data.type}
              </dd>
            </div>
            ...
            <div
              style={{
                gridColumn: "1 / -1",
                paddingTop: 22,
                borderTop: "1px solid color-mix(in oklab, var(--bigram-sage) 22%, transparent)",
              }}
            >
              <dt
                style={{
