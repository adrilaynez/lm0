...
const BackpropZeroDemo = lazy(() => import("@/features/lab/components/nn/BackpropZeroDemo").then(m => ({ default: m.BackpropZeroDemo })));
const BatchSizeComparisonVisualizer = lazy(() => import("@/features/lab/components/nn/BatchSizeComparisonVisualizer").then(m => ({ default: m.BatchSizeComparisonVisualizer })));
const BeatTheMachineChallenge = lazy(() => import("@/features/lab/components/nn/BeatTheMachineChallenge").then(m => ({ default: m.BeatTheMachineChallenge })));
const BiasDemo = lazy(() => import("@/features/lab/components/nn/BiasDemo").then(m => ({ default: m.BiasDemo })));
const BiologicalVsArtificialDiagram = lazy(() => import("@/features/lab/components/nn/BiologicalVsArtificialDiagram").then(m => ({ default: m.BiologicalVsArtificialDiagram })));
const ChainRuleBuilder = lazy(() => import("@/features/lab/components/nn/ChainRuleBuilder").then(m => ({ default: m.ChainRuleBuilder })));
const DeadNeuronDemo = lazy(() => import("@/features/lab/components/nn/DeadNeuronDemo").then(m => ({ default: m.DeadNeuronDemo })));
const DecisionBoundaryIntro = lazy(() => import("@/features/lab/components/nn/DecisionBoundaryIntro").then(m => ({ default: m.DecisionBoundaryIntro })));
const DerivativeIntuitionDemo = lazy(() => import("@/features/lab/components/nn/DerivativeIntuitionDemo").then(m => ({ default: m.DerivativeIntuitionDemo })));
const DivergenceDemo = lazy(() => import("@/features/lab/components/nn/DivergenceDemo").then(m => ({ default: m.DivergenceDemo })));
const FlatGradientVisualizer = lazy(() => import("@/features/lab/components/nn/FlatGradientVisualizer").then(m => ({ default: m.FlatGradientVisualizer })));
const GradientNoiseVisualizer = lazy(() => import("@/features/lab/components/nn/GradientNoiseVisualizer").then(m => ({ default: m.GradientNoiseVisualizer })));
const LearningRateDemo = lazy(() => import("@/features/lab/components/nn/LearningRateDemo").then(m => ({ default: m.LearningRateDemo })));
const LetterToNumberDemo = lazy(() => import("@/features/lab/components/nn/LetterToNumberDemo").then(m => ({ default: m.LetterToNumberDemo })));
const LinearStackingDemo = lazy(() => import("@/features/lab/components/nn/LinearStackingDemo").then(m => ({ default: m.LinearStackingDemo })));
const LossDerivativeVisualizer = lazy(() => import("@/features/lab/components/nn/LossDerivativeVisualizer").then(m => ({ default: m.LossDerivativeVisualizer })));
const LossFormulaMotivation = lazy(() => import("@/features/lab/components/nn/LossFormulaMotivation").then(m => ({ default: m.LossFormulaMotivation })));
const LossWeightParabolaVisualizer = lazy(() => import("@/features/lab/components/nn/LossWeightParabolaVisualizer").then(m => ({ default: m.LossWeightParabolaVisualizer })));
const LROvershootVisualizer = lazy(() => import("@/features/lab/components/nn/LROvershootVisualizer").then(m => ({ default: m.LROvershootVisualizer })));
const MatrixMultiplyVisual = lazy(() => import("@/features/lab/components/nn/MatrixMultiplyVisual").then(m => ({ default: m.MatrixMultiplyVisual })));
const NeuronGradientCalculator = lazy(() => import("@/features/lab/components/nn/NeuronGradientCalculator").then(m => ({ default: m.NeuronGradientCalculator })));
const NudgeWeightDemo = lazy(() => import("@/features/lab/components/nn/NudgeWeightDemo").then(m => ({ default: m.NudgeWeightDemo })));
const OperationExplorer = lazy(() => import("@/features/lab/components/nn/OperationExplorer").then(m => ({ default: m.OperationExplorer })));
const OutputLayerNetworkVisualizer = lazy(() => import("@/features/lab/components/nn/OutputLayerNetworkVisualizer").then(m => ({ default: m.OutputLayerNetworkVisualizer })));
const OverfittingPlayground = lazy(() => import("@/features/lab/components/nn/OverfittingPlayground").then(m => ({ default: m.OverfittingPlayground })));
const ParallelNeuronsDemo = lazy(() => import("@/features/lab/components/nn/ParallelNeuronsDemo").then(m => ({ default: m.ParallelNeuronsDemo })));
const PredictionErrorDemo = lazy(() => import("@/features/lab/components/nn/PredictionErrorDemo").then(m => ({ default: m.PredictionErrorDemo })));
const RepeatedTrainingDemo = lazy(() => import("@/features/lab/components/nn/RepeatedTrainingDemo").then(m => ({ default: m.RepeatedTrainingDemo })));
const SoftmaxTransformDemo = lazy(() => import("@/features/lab/components/nn/SoftmaxTransformDemo").then(m => ({ default: m.SoftmaxTransformDemo })));
const StepEpochBatchCounter = lazy(() => import("@/features/lab/components/nn/StepEpochBatchCounter").then(m => ({ default: m.StepEpochBatchCounter })));
const ToyAlphabetPredictor = lazy(() => import("@/features/lab/components/nn/ToyAlphabetPredictor").then(m => ({ default: m.ToyAlphabetPredictor })));
const ToyVowelTeaser = lazy(() => import("@/features/lab/components/nn/ToyVowelTeaser").then(m => ({ default: m.ToyVowelTeaser })));
const TrainingWithTextDemo = lazy(() => import("@/features/lab/components/nn/TrainingWithTextDemo").then(m => ({ default: m.TrainingWithTextDemo })));
const TrainValSplitVisualizer = lazy(() => import("@/features/lab/components/nn/TrainValSplitVisualizer").then(m => ({ default: m.TrainValSplitVisualizer })));
const WeightImpactVisualizer = lazy(() => import("@/features/lab/components/nn/WeightImpactVisualizer").then(m => ({ default: m.WeightImpactVisualizer })));
const WeightSliderDemo = lazy(() => import("@/features/lab/components/nn/WeightSliderDemo").then(m => ({ default: m.WeightSliderDemo })));
const WeightTrajectoryDemo = lazy(() => import("@/features/lab/components/nn/WeightTrajectoryDemo").then(m => ({ default: m.WeightTrajectoryDemo })));
const XORSolverDemo = lazy(() => import("@/features/lab/components/nn/XORSolverDemo").then(m => ({ default: m.XORSolverDemo })));
const NNActivationExplorer = lazy(() => import("@/features/lab/components/NNActivationExplorer").then(m => ({ default: m.NNActivationExplorer })));
const ModelOutputTeaser = lazy(() => import("@/features/lab/components/nn/ModelOutputTeaser").then(m => ({ default: m.ModelOutputTeaser })));
const ContextWindowTeaser = lazy(() => import("@/features/lab/components/nn/ContextWindowTeaser").then(m => ({ default: m.ContextWindowTeaser })));
const SquaredVsCrossEntropy = lazy(() => import("@/features/lab/components/mlp/SquaredVsCrossEntropy").then(m => ({ default: m.SquaredVsCrossEntropy })));
const CrossEntropyVisualizer = lazy(() => import("@/features/lab/components/mlp/CrossEntropyVisualizer").then(m => ({ default: m.CrossEntropyVisualizer })));
const NNBigramComparison = lazy(() => import("@/features/lab/components/NNBigramComparison").then(m => ({ default: m.NNBigramComparison })));
const NNLossLandscape = lazy(() => import("@/features/lab/components/NNLossLandscape").then(m => ({ default: m.NNLossLandscape })));
const NNPerceptronDiagram = lazy(() => import("@/features/lab/components/NNPerceptronDiagram").then(m => ({ default: m.NNPerceptronDiagram })));
const NNTrainingDemo = lazy(() => import("@/features/lab/components/NNTrainingDemo").then(m => ({ default: m.NNTrainingDemo })));
const OverfittingComparisonDiagram = lazy(() => import("@/features/lab/components/OverfittingComparisonDiagram").then(m => ({ default: m.OverfittingComparisonDiagram })));
const TrainValLossCurveVisualizer = lazy(() => import("@/features/lab/components/TrainValLossCurveVisualizer").then(m => ({ default: m.TrainValLossCurveVisualizer })));
...
function Predict({ children }: { children?: React.ReactNode }) {
    return <p className="text-[15px] md:text-base text-[var(--lab-text-muted)] leading-[1.9] mb-5 italic">{children}</p>;
}
    ...
    return (
        <div className="my-8 rounded-2xl border border-white/[0.08] bg-[var(--lab-viz-bg)] overflow-hidden">
            <div className="px-4 py-3 border-b border-white/[0.06] bg-white/[0.02]">
                <span className="text-[10px] font-mono uppercase tracking-widest text-white/30">{t(`${base}.title`)}</span>
            </div>
            <div className="grid grid-cols-2 divide-x divide-white/[0.06]">
                <div className="px-4 py-3 bg-rose-500/[0.02]">
                    <p className="text-[10px] font-mono font-bold uppercase tracking-widest text-rose-400/60 mb-3">{t(`${base}.countingCol`)}</p>
                </div>
                <div className="px-4 py-3 bg-emerald-500/[0.02]">
                    <p className="text-[10px] font-mono font-bold uppercase tracking-widest text-emerald-400/60 mb-3">{t(`${base}.learningCol`)}</p>
                </div>
            </div>
            {(["row1", "row2", "row3", "row4"] as const).map((row) => (
                <div key={row} className="grid grid-cols-2 divide-x divide-white/[0.06] border-t border-white/[0.04]">
                    <div className="px-4 py-3">
                        ...
                        <p className="text-xs text-rose-300/60 leading-relaxed">{t(`${base}.${row}Counting`)}</p>
                    </div>
                    <div className="px-4 py-3">
                        <p className="text-[10px] font-mono text-white/30 mb-1">{t(`${base}.${row}Label`)}</p>
                        <p className="text-xs text-emerald-300/60 leading-relaxed">{t(`${base}.${row}Learning`)}</p>
                    </div>
                </div>
            ))}
        </div>
...
function TermCards() {
    const { t } = useI18n();
    const HL = labMdxComponents("rose", {}).Highlight as (p: { color?: string; tooltip?: string; children?: React.ReactNode }) => React.ReactElement;
    const cards: { letter: string; term: string; desc: string; tip: string }[] = [
        { letter: "S", term: t("neuralNetworkNarrative.watchingItLearn.termStep"), desc: t("neuralNetworkNarrative.watchingItLearn.termStepDesc"), tip: t("neuralNetworkNarrative.narratorTooltips.step") },
        { letter: "E", term: t("neuralNetworkNarrative.watchingItLearn.termEpoch"), desc: t("neuralNetworkNarrative.watchingItLearn.termEpochDesc"), tip: t("neuralNetworkNarrative.narratorTooltips.epoch") },
        { letter: "B", term: t("neuralNetworkNarrative.watchingItLearn.termBatch"), desc: t("neuralNetworkNarrative.watchingItLearn.termBatchDesc"), tip: t("neuralNetworkNarrative.narratorTooltips.batch") },
    ];
    return (
        <div className="my-8 rounded-2xl border border-indigo-500/[0.15] bg-indigo-500/[0.02] p-5 sm:p-6 space-y-4">
            {cards.map(({ letter, term, desc, tip }) => (
                <div key={letter} className="flex items-start gap-3">
                    <span className="shrink-0 w-6 h-6 rounded-full bg-indigo-500/20 flex items-center justify-center text-[10px] font-bold text-indigo-400 mt-0.5">{letter}</span>
                    <div>
                        <p className="text-sm font-semibold text-white/70 mb-1">
                            <HL color="indigo" tooltip={tip}>{term}</HL>
                        </p>
...
function SupervisedFlow() {
    ...
    return (
        <>
            ...
            <div className="rounded-xl bg-black/20 border border-white/[0.05] p-3 mb-4 overflow-x-auto">
                <svg viewBox="0 0 340 64" className="w-full block" style={{ minWidth: 280 }}>
                    {[
                        ...
                        <g key={label}>
                            <rect x={x} y={8} width={72} height={36} rx={6} fill={col + "15"} stroke={col + "40"} strokeWidth={1} />
                            <text x={x + 36} y={24} textAnchor="middle" fill={col} fontSize="8" fontFamily="monospace" fontWeight="bold">{label}</text>
                            <text x={x + 36} y={36} textAnchor="middle" fill="rgba(255,255,255,0.3)" fontSize="7" fontFamily="monospace">{sub}</text>
                        </g>
                    ))}
                    {[76, 156, 236].map(ax => (
                        <g key={ax}>
                    ...
                    <path d="M280,26 Q310,26 310,50 Q310,58 258,58 Q200,58 200,50 Q200,44 244,44" fill="none" stroke="#f43f5e60" strokeWidth="1" strokeDasharray="3 2" />
                    <text x={258} y={62} textAnchor="middle" fill="#f43f5e80" fontSize="6.5" fontFamily="monospace">compare → loss → update weights</text>
                </svg>
            </div>

            <div className="grid grid-cols-3 gap-2 mb-4">
                {([
                    { emoji: "🖼️", input: t(`${base}.supervisedCard1Input`), output: t(`${base}.supervisedCard1Output`) },
                    { emoji: "✉️", input: t(`${base}.supervisedCard2Input`), output: t(`${base}.supervisedCard2Output`) },
                    { emoji: "🩻", input: t(`${base}.supervisedCard3Input`), output: t(`${base}.supervisedCard3Output`) },
            ...
            <p className="text-xs text-white/30 italic border-t border-white/[0.06] pt-3">{t(`${base}.supervisedNote`)}</p>
        </>
    );
}
    ...
    return (
        <div className="space-y-3 my-6">
            {(["q1", "q2", "q3"] as const).map((key, i) => (
                ...
                >
                    <span className="shrink-0 w-6 h-6 rounded-full bg-violet-500/20 flex items-center justify-center text-[10px] font-bold text-violet-400 mt-0.5">{i + 1}</span>
    ...
    return (
        <>
            ...
            <div className="my-10 py-8 border-t border-b border-violet-500/10 text-center space-y-4">
                ...
                <p className="text-[11px] font-mono text-white/25">{t("neuralNetworkNarrative.whatsNext.pClosingSub")}</p>
            </div>
        </>
    );
}
                    ...
                    >
                        <div className="px-6 pb-6 border-t border-white/[0.06] pt-5">
                                    ...
                                    <div className="relative flex justify-between items-start">
                                        {timelineEvents.map((event, idx) => (
                                            ...
                                            >
                                                ...
                                                <span className="mt-2 text-[10px] font-bold font-mono text-white/60 whitespace-nowrap">{event.year}</span>
                                                <span className="mt-1 text-[9px] text-white/30 text-center max-w-[60px] leading-tight">{event.label}</span>
                                            </motion.div>
                                        ))}
                                    </div>
                                </div>
                            ...
                            <div className="space-y-5">
                                {([
                                    { year: "1943", border: "border-blue-500/30", num: "text-blue-400", kicker: "text-blue-400/60", label: "The Seed", key: "p1" },
                                    { year: "1958", border: "border-emerald-500/30", num: "text-emerald-400", kicker: "text-emerald-400/60", label: "First Steps", key: "p2" },
                                    { year: "1969", border: "border-slate-500/30", num: "text-slate-400", kicker: "text-slate-400/60", label: "The Winter", key: "p3" },
                                    { year: "1970s", border: "border-slate-500/20", num: "text-slate-500", kicker: "text-slate-500/60", label: "The Persistence", key: "p3_5" },
                                    { year: "1986", border: "border-amber-500/30", num: "text-amber-400", kicker: "text-amber-400/60", label: "The Thaw", key: "p4" },
                                ] as const).map((e, i) => (
                                    <motion.div
                                        key={e.key}
                                    ...
                                    >
                                        <div className="flex items-baseline gap-3 mb-2">
                                            <span className={`text-2xl font-bold ${e.num} font-mono shrink-0`}>{e.year}</span>
                                            <span className={`text-xs uppercase tracking-wider ${e.kicker} font-semibold`}>{e.label}</span>
                                        </div>
                                        <p className="text-sm text-white/50 leading-relaxed">{t(`neuralNetworkNarrative.history.${e.key}`)}</p>
                                    </motion.div>
                                ))}
                    ...
                    <ul className="space-y-3">
                        {(["whatsNext1", "whatsNext2", "whatsNext3"] as const).map((key, i) => (
                            <li key={key} className="flex items-start gap-3">
                                <span className="shrink-0 w-5 h-5 rounded-full bg-rose-500/20 flex items-center justify-center text-[10px] font-bold text-rose-400 mt-0.5">{i + 1}</span>
