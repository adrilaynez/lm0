...
const CombinatoricExplosionTable = lazy(() => import("@/features/lab/components/CombinatoricExplosionTable").then(m => ({ default: m.CombinatoricExplosionTable })));
const ConcreteImprovementExample = lazy(() => import("@/features/lab/components/ConcreteImprovementExample").then(m => ({ default: m.ConcreteImprovementExample })));
const CountingComparisonWidget = lazy(() => import("@/features/lab/components/CountingComparisonWidget").then(m => ({ default: m.CountingComparisonWidget })));
const ExponentialGrowthAnimator = lazy(() => import("@/features/lab/components/ExponentialGrowthAnimator").then(m => ({ default: m.ExponentialGrowthAnimator })));
const GeneralizationFailureDemo = lazy(() => import("@/features/lab/components/GeneralizationFailureDemo").then(m => ({ default: m.GeneralizationFailureDemo })));
const GrowingTablesComparison = lazy(() => import("@/features/lab/components/GrowingTablesComparison").then(m => ({ default: m.GrowingTablesComparison })));
const InfiniteTableThoughtExperiment = lazy(() => import("@/features/lab/components/InfiniteTableThoughtExperiment").then(m => ({ default: m.InfiniteTableThoughtExperiment })));
const NgramGenerationBattle = lazy(() => import("@/features/lab/components/NgramGenerationBattle").then(m => ({ default: m.NgramGenerationBattle })));
const NgramInteractiveGenerator = lazy(() => import("@/features/lab/components/NgramInteractiveGenerator").then(m => ({ default: m.NgramInteractiveGenerator })));
const NgramMiniTransitionTable = lazy(() => import("@/features/lab/components/NgramPedagogyPanels").then(m => ({ default: m.NgramMiniTransitionTable })));
const NgramFiveGramScale = lazy(() => import("@/features/lab/components/NgramPedagogyPanels").then(m => ({ default: m.NgramFiveGramScale })));
const SimilarityBlindSpot = lazy(() => import("@/features/lab/components/SimilarityBlindSpot").then(m => ({ default: m.SimilarityBlindSpot })));
const SparsityHeatmap = lazy(() => import("@/features/lab/components/SparsityHeatmap").then(m => ({ default: m.SparsityHeatmap })));
const StatisticalEraTimeline = lazy(() => import("@/features/lab/components/StatisticalEraTimeline").then(m => ({ default: m.StatisticalEraTimeline })));
const TypoWordBreaker = lazy(() => import("@/features/lab/components/TypoWordBreaker").then(m => ({ default: m.TypoWordBreaker })));
