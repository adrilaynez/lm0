...
/* Chapter narrative MDX — one dynamic() per locale so each language is its own chunk and
   only the active one ships (the other loads on toggle). ssr stays on, so the prose is
   still server-rendered (no first-paint flash, SEO intact). */
const BigramEnBody = dynamic(() => import("@/content/lab/bigram.en.mdx"));
const BigramEsBody = dynamic(() => import("@/content/lab/bigram.es.mdx"));
  ...
  return (
    <FadeInView className="my-12 text-center">
      ...
      <p
        className={cn(
          BIGRAM_SERIF,
          "mt-5 text-[clamp(17px,1.9vw,20px)] text-bigram-body leading-relaxed max-w-[34em] mx-auto text-pretty",
        )}
      >
        {coda}
      </p>
  ...
  return (
    <blockquote
      ...
      style={{
        ...
        borderLeft: "2px solid var(--bigram-accent)",
      }}
    >
      “{children}”
    </blockquote>
...
export function BigramNarrative(props: BigramNarrativeProps) {
  ...
  const Body = language === "es" ? BigramEsBody : BigramEnBody;
  ...
  return (
    <article className="relative z-[1] max-w-[880px] mx-auto px-7 pt-8 pb-24">
        ...
        sections={[
          {
            id: "bigram-01",
            label: "01",
            name: t("bigramNarrative.v2.sectionKickers.s1"),
            weight: 2.2,
          },
          {
            id: "bigram-02",
            label: "02",
            name: t("bigramNarrative.v2.sectionKickers.s2"),
            weight: 3.2,
          },
          {
            id: "bigram-03",
            label: "03",
            name: t("bigramNarrative.v2.sectionKickers.s3"),
            weight: 2.6,
          },
          {
            id: "bigram-04",
            label: "04",
            name: t("bigramNarrative.v2.sectionKickers.s4"),
            weight: 3.0,
          },
          {
            id: "bigram-05",
            label: "05",
            name: t("bigramNarrative.v2.sectionKickers.s5"),
            weight: 2.8,
          },
          {
            id: "bigram-06",
            label: "06",
            name: t("bigramNarrative.v2.sectionKickers.s6"),
            weight: 2.2,
          },
        ]}
      />
      ...
      <header className="text-left pt-8 md:pt-16 mb-16 md:mb-20">
        ...
        >
          <span
            className={cn(
              BIGRAM_MONO,
              "inline-flex items-center gap-3 text-[12px] font-medium uppercase tracking-[0.18em] text-bigram-accent mb-8",
            )}
          >
          ...
          >
            ...
            <span
              className="italic text-bigram-accent"
          ...
          <p
            className={cn(
              BIGRAM_SERIF,
              "text-[clamp(21px,2.2vw,25px)] font-normal text-bigram-ink-2 leading-[1.5] max-w-[33em] mb-9 text-pretty",
            )}
          >
        ...
        <div className="space-y-4">
          ...
          <Link href={t("bigramNarrative.v2.cta.primaryHref")} className="block focus:outline-none">
            ...
            >
              ...
              <div
                aria-hidden
                className="pointer-events-none absolute inset-0 bg-[radial-gradient(130%_150%_at_100%_0%,var(--bigram-accent-soft),transparent_58%)] opacity-50 transition-opacity duration-500 group-hover:opacity-100"
              />
              ...
              <span
                ...
                className={cn(
                  BIGRAM_DISPLAY,
                  "pointer-events-none absolute -top-9 right-2 select-none text-[150px] font-bold leading-none text-[color-mix(in_oklab,var(--bigram-accent)_7%,transparent)]",
                )}
              >
                2
              </span>
              ...
              <span
                aria-hidden
                className="pointer-events-none absolute inset-y-0 left-0 w-1/4 -translate-x-[160%] -skew-x-12 bg-[linear-gradient(90deg,transparent,color-mix(in_oklab,var(--bigram-accent)_12%,transparent),transparent)] transition-transform duration-[900ms] ease-out group-hover:translate-x-[460%]"
              />
              ...
              <div className="relative">
                <div className="mb-4 flex items-center gap-3">
                  <span
                    className={cn(
                      BIGRAM_MONO,
                      "text-[10.5px] uppercase tracking-[0.22em] text-bigram-accent",
                    )}
                  >
                  ...
                  <span
                    aria-hidden
                    className="h-px w-8 bg-[color-mix(in_oklab,var(--bigram-accent)_40%,transparent)]"
                  />
                  <span
                    className={cn(
                      BIGRAM_MONO,
                      "text-[10.5px] uppercase tracking-[0.14em] text-bigram-muted",
                    )}
                  >
                ...
                <h3
                  className={cn(
                    BIGRAM_SERIF,
                    "max-w-[30ch] text-[clamp(21px,2.6vw,28px)] font-semibold leading-[1.2] tracking-tight text-bigram-ink",
                  )}
                >
                ...
                <p
                  className={cn(
                    BIGRAM_SERIF,
                    "mt-2.5 max-w-[48ch] text-[15px] leading-relaxed text-bigram-muted",
                  )}
                >
                ...
                <div className="mt-7 inline-flex items-center gap-3.5">
                  ...
                  <span
                    className={cn(
                      BIGRAM_MONO,
                      "text-[12px] font-semibold uppercase tracking-[0.16em] text-bigram-accent",
                    )}
                  >
      ...
      <FadeInView
        as="footer"
        className="mt-8 pt-12 border-t border-[color:var(--bigram-rule)] text-center"
      >
        <div
          className={cn(
            BIGRAM_MONO,
            "flex items-center justify-center gap-2 text-[10px] uppercase tracking-widest text-bigram-dim",
          )}
        >
