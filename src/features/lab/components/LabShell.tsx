...
function LabShellInner({ children }: { children: React.ReactNode }) {
  ...
  const pageId = pathname?.replace(/^\//, "").replace(/\//g, "-") || "landing";
  ...
  const isBigram = pathname?.startsWith("/bigram") ?? false;
  const readingAccent = isBigram
    ? "bigram"
    : pathname?.startsWith("/ngram")
      ? "amber"
      : pathname?.startsWith("/mlp")
        ? "violet"
        : pathname?.startsWith("/transformer")
          ? "cyan"
          : "rose";

  const models = [
    { id: "bigram", label: t("lab.bigram"), href: "/bigram", ready: true },
    { id: "ngram", label: t("lab.ngram"), href: "/ngram", ready: true },
    {
      id: "neural-networks",
      label: t("lab.neuralNetworks"),
      href: "/neural-networks",
      ready: true,
    },
    { id: "mlp", label: t("lab.mlp"), href: "/mlp", ready: true },
    { id: "transformer", label: t("lab.transformer"), href: "/transformer", ready: true },
  ];
  ...
  return (
    ...
    >
      ...
      <header
        ...
        style={
          isBigram
            ? { backgroundColor: "color-mix(in oklab, var(--bigram-bg) 92%, transparent)" }
            : undefined
        }
      >
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{
                        ...
                        transform:
                          theme === "dark" ? "rotate(0deg) scale(1)" : "rotate(-90deg) scale(0.5)",
                      }}
                    >
                    ...
                    <span
                      ...
                      style={{
                        ...
                        transform:
                          theme === "dark" ? "rotate(90deg) scale(0.5)" : "rotate(0deg) scale(1)",
                      }}
                    >
