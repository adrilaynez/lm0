...
const BigramDiagramExperience = dynamic(() =>
  import("@/features/lab/components/BigramDiagramExperience").then(
    (m) => m.BigramDiagramExperience,
  ),
);
...
function BigramPageContent() {
  ...
  return (
    <LabShell>
      <div data-bigram-theme={theme} className="bg-bigram-bg text-bigram-ink min-h-screen">
        ...
        {isEducational ? (
          ...
          <div className="relative z-[1] max-w-7xl mx-auto pb-24">
            ...
            <FadeInView margin="-60px" className="mb-28">
              <ArchitectureDeepDive data={viz.data?.visualization.architecture ?? null} />
            </FadeInView>
