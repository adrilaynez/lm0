...
const NeuralNetworkNarrative = dynamic(
  () =>
    import("@/features/lab/components/NeuralNetworkNarrative").then((m) => ({
      default: m.NeuralNetworkNarrative,
    })),
...
const GuidedExperiments = dynamic(
  () =>
    import("@/features/lab/components/GuidedExperiments").then((m) => ({
      default: m.GuidedExperiments,
    })),
  { ssr: false },
);
