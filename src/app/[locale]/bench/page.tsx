...
/**
 * /bench — dev-only widget bench for the Bigram chapter.
 *
 ...
 *
 * Usage:  /bench?w=<slug>&theme=<light|dark>
 */
          ...
          >
            ...
            {WIDGETS.map((w) => {
              ...
              return (
                <a
                  key={w.slug}
                  href={`/bench?w=${w.slug}&theme=${theme}`}
                  style={{
                    fontFamily: MONO,
                    fontSize: 11.5,
                    textDecoration: "none",
            ...
            <a
              href={`/bench?w=${slug}&theme=${otherTheme}`}
              style={{
                marginLeft: "auto",
                fontFamily: MONO,
                fontSize: 11.5,
