...
export const es: TranslationDictionary = {
        ...
        mlp: {
            ...
            narrative: {
                hero: {
                    ...
                    titlePrefix: "El Problema de la Entrada:",
                    titleHighlight: "MLP + Embeddings",
                    description: "Nuestra red neuronal puede aprender — pero solo ve una letra a la vez. ¿Cómo alimentamos contexto a una red, y qué pasa cuando la dejamos aprender sus propias representaciones?",
                    readTime: "~45 min de lectura · 50+ demos interactivos",
                },
                sections: {
                    s01: { number: "01", label: "El Problema de Entrada" },
                    s02: { number: "02", label: "Representación" },
                    s03: { number: "03", label: "Embeddings en Acción" },
                    s04: { number: "04", label: "El Pipeline Completo" },
                    s05: { number: "05", label: "Profundizando" },
                    s06: { number: "06", label: "Estabilidad" },
                    s07: { number: "07", label: "Hiperparámetros" },
                    s08: { number: "08", label: "Limitaciones" },
                    s09: { number: "09", label: "El Camino Adelante" },
                },
                s01: {
                    heading: "El Problema de Entrada: Alimentando Contexto a una Red",
                    lead: "Nuestra red neuronal puede aprender — pero es ciega. Ve una letra, adivina la siguiente y olvida. Para construir algo más inteligente, necesitamos resolver un problema fundamental: ¿cómo alimentas CONTEXTO a una red neuronal?",
                    evolutionLabel: "El camino hasta aquí",
                    bigramLabel: "Bigrama",
                    bigramDesc: "1 letra, contando",
                    ngramLabel: "N-grama",
                    ngramDesc: "N letras, contando (¡explota!)",
                    nnLabel: "Red Neuronal",
                    nnDesc: "1 letra, aprendiendo",
                    mlpLabel: "MLP",
                    mlpDesc: "N letras, aprendiendo ← ¡esto!",
                    p1: "En el capítulo de Redes Neuronales, codificamos cada carácter como un entero — 'a'=0, 'b'=1, etc. — y lo alimentamos a una sola neurona. Eso funcionó para contexto de una letra. ¿Pero qué pasa si queremos ver 3 letras a la vez?",
                    p2: "La idea más simple: toma 3 caracteres, convierte cada uno en un",
                    p2H1: "vector one-hot",
                    p2End: " (una lista de ceros con un solo 1), y concaténalos en un vector de entrada largo.",
                    ...
                    p3: "¡Esto funciona! Pero hay un problema. Cada vector one-hot tiene V dimensiones (una por carácter del vocabulario). Con ventana de contexto N, el vector de entrada tiene",
                    p3H1: "N × V",
                    p3End: " dimensiones. A medida que crece el contexto, la entrada — y la matriz de pesos que la conecta con la capa oculta — crece con él.",
                    figLabel2: "Interactivo · Escala de Dimensionalidad",
                    figHint2: "Arrastra el deslizador para aumentar el tamaño de contexto. Observa cómo las dimensiones de entrada y la matriz de pesos explotan — y compara con el enfoque de embeddings.",
                    p4: "Con un vocabulario de 27 caracteres y contexto de 3, la entrada tiene 81 dimensiones — bien. Pero con contexto de 10, son 270. Con 20, son 540. Y la primera matriz de pesos W₁ crece proporcionalmente.",
                    formulaCaption: "La entrada al MLP es una concatenación de N vectores one-hot, uno por token de contexto.",
                    calloutTitle: "De una letra a muchas",
                    calloutText: "Este es el paso clave: en lugar de alimentar una letra, alimentamos N letras. El N-grama tenía esta idea pero almacenaba conteos en tablas que crecían exponencialmente. El MLP aprende una función compacta — mismo contexto, dramáticamente menos parámetros.",
                    archLabel: "Arquitectura MLP · Esquema",
                    archHint: "La arquitectura que acabas de diseñar: N vectores one-hot de contexto → entrada concatenada → capas ocultas → salida softmax.",
                    p5: "¿El contexto realmente ayuda? Averigüémoslo. Abajo, escribe texto y compara predicciones de un modelo que ve 1 letra versus uno que ve 3.",
                    figLabel3: "Interactivo · Contexto vs Sin Contexto",
                    figHint3: "Escribe texto y compara predicciones: contexto=1 (solo la última letra) versus contexto=3 (últimas 3 letras). Ve cómo el contexto mejora la precisión.",
                    takeaway: "Alimentar múltiples caracteres como vectores one-hot concatenados le da al MLP contexto — la capacidad de ver patrones entre caracteres. Pero el tamaño de entrada crece linealmente con el contexto, y cada carácter está igualmente distante de todos los demás. ¿Podemos hacerlo mejor?",
                },
                s02: {
                    heading: "El Problema de Representación: Más Allá de One-Hot",
                    lead: "Cada carácter está a la misma distancia de todos los demás. La red no obtiene ninguna información sobre similitud de la codificación. ¿Y si pudiéramos dar a los caracteres coordenadas significativas?",
                    ...
                    p2: "Al ordenar caracteres en grupos, acabas de hacer algo notable: asignaste a cada letra un conjunto de características. ¿Y si en lugar de categorías, asignaras",
                    p2H1: "números",
                    p2End: "? Entonces cada letra se convertiría en un punto en un espacio de coordenadas, y las letras similares terminarían naturalmente cerca unas de otras.",
                    ...
                    p3: "Con características significativas, las vocales se agrupan naturalmente y las consonantes raras se separan. Pero ¿quién elige las características? Podríamos diseñarlas a mano... o podríamos dejar que la red las",
                    p3H1: "aprenda automáticamente",
                    p3End: ". Esta es la idea clave: definir una matriz E de forma V × D, donde V es el tamaño del vocabulario y D es la dimensión del embedding. Cada fila es la representación aprendida de un carácter.",
                    formulaCaption: "Búsqueda de embedding: seleccionar la fila t de la matriz E da un vector denso de D dimensiones.",
                    ...
                    takeaway: "Los embeddings reemplazan los vectores one-hot desperdiciados con representaciones densas y aprendidas donde tokens similares obtienen vectores similares. En lugar de N × V dimensiones de entrada, ahora tenemos N × D — órdenes de magnitud más pequeño, con similitud incorporada.",
                },
                s03: {
                    heading: "Embeddings en Acción: ¿Qué Aprenden?",
                    lead: "Le dijimos a la red que aprenda sus propias representaciones. Pero ¿qué descubre realmente? Observemos cómo evolucionan los embeddings durante el entrenamiento y exploremos la estructura que emerge.",
                    p1: "En el paso 0, el embedding de cada carácter es ruido aleatorio — sin estructura alguna. A medida que avanza el entrenamiento, la red gradualmente acerca los caracteres similares. Observa cómo sucede en tiempo real abajo.",
                    ...
                    p2: "Al final del entrenamiento, las vocales se agrupan, las consonantes comunes forman su propio grupo, y los caracteres raros se desplazan a la periferia. La red descubrió estas agrupaciones por sí sola — nunca le dijimos sobre vocales o consonantes.",
                    figLabel2: "Interactivo · Explorador del Espacio de Embeddings",
                    figHint2: "Haz clic en cualquier carácter para resaltarlo y explorar el espacio de embeddings aprendido. Esta es una ilustración pedagógica del patrón de clustering.",
                    p3: "¿Qué tan cerca están dos caracteres en el espacio de embeddings? Podemos medirlo con",
                    p3H1: "distancia Euclidiana",
                    p3Mid: " (distancia en línea recta) y",
                    p3H2: "similitud coseno",
                    p3End: " (ángulo entre vectores). Los caracteres que aparecen en contextos similares terminan con embeddings similares.",
                    ...
                    p4: "Para cualquier carácter, podemos encontrar sus vecinos más cercanos — los caracteres cuyos embeddings son más similares. Esto revela lo que la red considera 'relacionado'.",
                    figLabel4: "Interactivo · Explorador de Vecinos Cercanos",
                    figHint4: "Selecciona un carácter y ve cuáles otros caracteres tienen los embeddings aprendidos más similares.",
                    p5: "Incluso podemos hacer aritmética con embeddings. Los centroides de grupo revelan cómo la red organiza los caracteres internamente — y las operaciones vectoriales muestran si las relaciones se codifican como direcciones consistentes.",
                    ...
                    p6: "¿Importa la dimensión del embedding? Abajo, compara embeddings entrenados con 2, 10 y 32 dimensiones. Más dimensiones capturan estructura más fina — pero incluso 2 dimensiones muestran clustering notable.",
                    ...
                    calloutTitle: "Bengio et al., 2003",
                    calloutText: "Este enfoque — aprender representaciones densas de tokens discretos y usarlas como entradas de redes neuronales — fue propuesto por Yoshua Bengio y colegas en su artículo histórico de 2003 'A Neural Probabilistic Language Model'. Sentó las bases de todos los modelos de lenguaje modernos.",
                    takeaway: "Los embeddings entrenados no son aleatorios — descubren estructura significativa. Las vocales se agrupan, las consonantes se organizan por tipo, y las representaciones mejoran con más dimensiones. Esta estructura aprendida es lo que le da al MLP su poder de generalización.",
                },
                s04: {
                    heading: "Construyendo el Pipeline Completo",
                    lead: "Tenemos ventanas de contexto, embeddings y capas ocultas. Ahora veamos cómo todas las piezas se conectan — desde texto crudo hasta una predicción — y entendamos qué hace esto fundamentalmente diferente de contar.",
                    p1: "Tracemos un ejemplo concreto. Dada la entrada \"hel\", nuestro MLP necesita predecir el siguiente carácter. Recorre cada paso abajo — desde caracteres a IDs de tokens, a través de la búsqueda de embeddings, concatenación, capa oculta, y finalmente la salida softmax.",
                    figLabel1: "Interactivo · Paso a Paso del Forward Pass",
                    figHint1: "Haz clic en 'Siguiente Paso' para recorrer el forward pass del MLP: entrada → tokenizar → embed → concatenar → capa oculta → predicción softmax.",
                    p2: "Eso fue un forward pass — una predicción. ¿Pero cómo aprende realmente la red? Entrenar significa repetir un ciclo: predecir, medir el error, calcular gradientes y actualizar pesos. Observa una iteración completa de entrenamiento abajo.",
                    figLabel2: "Interactivo · Entrenador de Ejemplo Único",
                    figHint2: "Recorre el bucle de entrenamiento: forward pass → pérdida cross-entropy → backpropagation → actualización de pesos. Haz clic en 'Siguiente Iteración' para ver la pérdida disminuir.",
                    p3: "El modelo N-gram almacenaba una tabla de búsqueda gigante — una entrada para cada secuencia posible de caracteres. El MLP almacena matrices de pesos compactas. ¿Cómo se comparan los conteos de parámetros?",
                    p3H1: "La diferencia es dramática",
                    p3End: " — y crece exponencialmente con el tamaño del contexto.",
                    figLabel3: "Interactivo · Parámetros N-gram vs MLP",
                    figHint3: "Ajusta el tamaño del vocabulario, longitud del contexto, dimensión del embedding y tamaño oculto. Compara la tabla exponencial del N-gram con las matrices compactas del MLP.",
                    p4: "Ahora usemos el modelo entrenado de verdad. Escribe cualquier texto abajo y observa al MLP predecir el siguiente carácter en tiempo real — usando el modelo entrenado real, no una simulación.",
                    figLabel4: "Interactivo · Predictor MLP en Vivo",
                    figHint4: "Escribe texto y ve predicciones de siguiente carácter en tiempo real de un MLP entrenado. Haz clic en los caracteres predichos para agregarlos y seguir generando.",
                    p5: "Finalmente, aquí está el pipeline completo de principio a fin — cada componente trabajando junto como un sistema unificado.",
                    figLabel5: "Interactivo · Pipeline MLP Completo",
                    figHint5: "El pipeline completo del modelo de lenguaje MLP: búsqueda de embedding → concatenación → capas ocultas → softmax → predicción del siguiente carácter.",
                    calloutTitle: "De contar a aprender",
                    calloutText: "El N-gram contaba secuencias exactas y las buscaba en una tabla. El MLP aprende representaciones comprimidas y calcula predicciones mediante operaciones matriciales. Esto significa que puede generalizar a secuencias que nunca ha visto antes — siempre que los caracteres componentes tengan embeddings similares a los que ha visto.",
                    takeaway: "El pipeline MLP transforma caracteres crudos en predicciones a través de una cadena de transformaciones aprendidas: tokenizar → embed → concatenar → capa oculta → softmax. A diferencia de la tabla exponencial del N-gram, los parámetros del MLP crecen linealmente con el tamaño del contexto.",
                },
                s05: {
                    heading: "Profundizando: ¿Qué Pasa con Más Capas?",
                    lead: "Una capa oculta funciona. El lenguaje es composicional — letras forman patrones, patrones forman palabras, palabras forman frases. ¿Qué pasa si añadimos más capas para capturar esta jerarquía?",
                    p1: "Experimentemos. Abajo, añade de 1 a 4 capas ocultas y observa cómo cambia el modelo — más parámetros, potencialmente menor pérdida, pero también nuevos problemas.",
                    figLabel1: "Interactivo · Explorador de Profundidad",
                    figHint1: "Selecciona 1-4 capas ocultas. Ve cómo crecen los parámetros, cambia la pérdida y se afecta la calidad de generación. Nota el punto óptimo — y la inestabilidad más allá.",
                    p2: "¿Qué está pasando dentro de cada capa? A medida que los datos fluyen a través de una red profunda, las activaciones en cada capa nos dicen qué características está detectando. Veamos los patrones de activación.",
                    figLabel2: "Interactivo · Explorador de Activaciones por Capa",
                    figHint2: "Haz clic en las capas para ver mapas de calor de activación. En capas más profundas, nota cómo los valores se concentran en los extremos — esto es saturación.",
                    p3: "El histograma de activaciones hace el problema más claro. En la capa 1, los valores están distribuidos saludablemente. Para la capa 3, la mayoría de los valores están empujados a ±1 — la zona de saturación de tanh donde",
                    p3H1: "los gradientes son casi cero",
                    p3End: ".",
                    figLabel3: "Interactivo · Histogramas de Activación por Capa",
                    figHint3: "Compara distribuciones de activación entre capas. Las capas más profundas muestran distribuciones bimodales acumulándose en ±1 — la zona muerta de tanh.",
                    p4: "¿Cómo afecta la profundidad al texto generado real? Compara las salidas de modelos con 1, 2 y 3 capas entrenados con los mismos datos.",
                    figLabel4: "Interactivo · Galería de Generación por Profundidad",
                    figHint4: "Muestras de texto lado a lado de modelos con diferentes profundidades. El modelo de 2 capas es el punto óptimo — 3 capas produce peor texto debido a inestabilidad en el entrenamiento.",
                    calloutTitle: "La paradoja de la profundidad",
                    calloutText: "Más capas deberían significar más poder expresivo — y matemáticamente así es. Pero en la práctica, las redes profundas son mucho más difíciles de entrenar. Las activaciones se saturan, los gradientes se desvanecen, y la red termina peor que una más superficial. Resolver esto requiere entender POR QUÉ el entrenamiento se rompe.",
                    takeaway: "Añadir capas aumenta la capacidad teórica de la red, pero más allá de 2 capas, el entrenamiento se vuelve inestable. Las activaciones se saturan en ±1, los gradientes se reducen a casi cero, y el modelo realmente empeora. Entender esta falla es la clave para profundizar.",
                },
                s06: {
                    heading: "Estabilidad del Entrenamiento: Cuando la Profundidad Contraataca",
                    lead: "Vimos que las redes profundas deberían ser más poderosas pero a menudo entrenan peor. ¿Por qué? La respuesta involucra tres problemas interconectados — y tres soluciones que revolucionaron el aprendizaje profundo.",
                    p1: "El primer problema es la inicialización. Si los pesos comienzan muy grandes, las activaciones explotan. Muy pequeños, y la señal se desvanece antes de llegar a la salida. Abajo, ve cómo tres escalas de inicialización diferentes producen resultados de entrenamiento muy distintos.",
                    ...
                    p2: "¿Por qué importa tanto la inicialización? Por la saturación de tanh. Cuando las entradas a tanh son grandes, la salida queda atascada cerca de ±1 y la derivada cae a casi cero. Arrastra el deslizador para encontrar la zona muerta.",
                    figLabel2: "Interactivo · Saturación de Tanh",
                    figHint2: "Arrastra x para ver tanh(x) y su derivada. Cuando |x| > 2, la derivada se acerca a 0 — los gradientes a través de esta neurona mueren.",
                    p3: "El segundo problema son los gradientes que se desvanecen y explotan. Durante la retropropagación, los gradientes se multiplican a través de cada capa. Si cada factor es menor que 1, los gradientes se reducen exponencialmente. Mayor que 1, explotan.",
                    figLabel3: "Interactivo · Simulador de Producto de Gradientes",
                    figHint3: "Establece un factor de gradiente por capa y número de capas. Observa cómo el gradiente total se desvanece o explota — incluso pequeñas desviaciones de 1.0 se acumulan dramáticamente.",
                    p4: "La visualización de abajo muestra las magnitudes de gradiente fluyendo hacia atrás a través de una red. En el régimen de desvanecimiento, las capas tempranas apenas reciben señal de aprendizaje.",
                    figLabel4: "Interactivo · Flujo de Gradientes",
                    ...
                    p5: "Solución 1: Mejor inicialización. La inicialización Kaiming escala los pesos basándose en el tamaño de la capa, manteniendo la varianza estable a través de cada capa. Compárala contra una inicialización aleatoria ingenua.",
                    figLabel5: "Interactivo · Comparación de Inicialización",
                    figHint5: "Entrenamiento lado a lado: init aleatoria vs init Kaiming. Observa cómo Kaiming converge más rápido y alcanza menor pérdida.",
                    p6: "Solución 2: Normalización por Lotes. Sin ella, las distribuciones de activación se desvían impredeciblemente durante el entrenamiento — el problema de 'cambio interno de covarianza'. Batch norm re-centra y re-escala las activaciones en cada capa.",
                    figLabel6: "Interactivo · Deriva de Activaciones",
                    figHint6: "Alterna entre 'Sin Batch Norm' y 'Con Batch Norm'. Observa cómo las distribuciones se desvían vs se mantienen estables a lo largo de los pasos de entrenamiento.",
                    p7: "Aquí está la fórmula de normalización por lotes en acción — normalizando activaciones a media cero y varianza unitaria, luego aplicando parámetros aprendidos de escala y desplazamiento.",
                    figLabel7: "Interactivo · Efecto de Batch Norm",
                    figHint7: "Activa y desactiva BatchNorm para ver cómo estabiliza las distribuciones de activación entre capas.",
                    p8: "Solución 3 (adelanto): Conexiones residuales. En lugar de y = f(x), calcula y = x + f(x). La señal original siempre pasa, dando a los gradientes una autopista directa de vuelta a las capas tempranas.",
                    figLabel8: "Interactivo · Conexiones Residuales",
                    figHint8: "Compara y = f(x) vs y = x + f(x). Ve cómo la conexión de salto preserva la fuerza de la señal a través de capas profundas.",
                    calloutTitle: "El kit de herramientas del aprendizaje profundo",
                    calloutText: "Inicialización Kaiming (2015), Normalización por Lotes (Ioffe & Szegedy, 2015), y Conexiones Residuales (He et al., 2015) — todos publicados el mismo año — transformaron el aprendizaje profundo de poco fiable a rutinario. Estas tres técnicas juntas permitieron entrenar redes con más de 100 capas.",
                    takeaway: "El entrenamiento profundo falla por saturación, gradientes que se desvanecen y deriva de distribuciones. Las soluciones — inicialización adecuada, normalización por lotes y conexiones residuales — abordan cada problema directamente. Juntas, hacen que las redes profundas sean entrenables.",
                },
                s07: {
                    heading: "Explorando el Paisaje: Hiperparámetros",
                    lead: "Hemos construido el pipeline, explorado la profundidad y domado la inestabilidad del entrenamiento. Ahora la pregunta práctica: ¿qué tan grande debería ser nuestro MLP? ¿Qué configuración produce el mejor modelo?",
                    ...
                    p3: "El programa de tasa de aprendizaje controla qué tan agresivamente el optimizador actualiza los pesos a lo largo del tiempo. Una tasa constante a menudo oscila; las estrategias de decaimiento y calentamiento ayudan.",
                    ...
                    p5: "Ahora ponlo todo junto. El explorador completo de hiperparámetros te permite comparar modelos reales entrenados de nuestra cuadrícula — ve cómo todas estas elecciones interactúan.",
                    ...
                    takeaway: "Los hiperparámetros controlan el equilibrio entre capacidad y generalización. La dimensión del embedding, el tamaño oculto, el programa de tasa de aprendizaje y la temperatura moldean el comportamiento del modelo. La mejor configuración equilibra expresividad con la capacidad de generalizar a datos no vistos.",
                },
                s08: {
                    heading: "Los Límites del MLP",
                    lead: "Hemos optimizado todo lo posible. El MLP está en su mejor momento — y sigue siendo fundamentalmente limitado. Entender exactamente dónde falla revela lo que la siguiente arquitectura debe resolver.",
                    ...
                    p2H1: "Limitación 1: Ventana de contexto fija.",
                    ...
                    p3H1: "Limitación 2: Significado dependiente de la posición.",
                    p3: "Como el MLP concatena embeddings de extremo a extremo, el mismo token en diferentes posiciones activa columnas de pesos completamente diferentes. No hay comprensión compartida de lo que significa un token — solo lo que significa en esta posición específica.",
                    ...
                    figLabel4: "Interactivo · Compartición de Pesos por Posición",
                    figHint4: "Ve exactamente qué columnas de W₁ se activan para 'e' en la posición 0, 1 o 2. No se comparten pesos entre posiciones.",
                    p4H1: "Limitación 3: Las dependencias de largo alcance son inalcanzables.",
                    p4: "En el lenguaje real, un pronombre puede referirse a un sustantivo decenas de tokens antes. Ninguna ventana fija de tamaño práctico puede cerrar estos huecos de manera confiable.",
                    ...
                    p5H1: "Limitación 4: Cuello de botella por concatenación.",
                    ...
                    p6H1: "Limitación 5: Sin compartición de parámetros.",
                    p6: "El MLP aprende pesos completamente separados para cada posición. No puede reconocer que 'the' en la posición 0 y 'the' en la posición 2 son la misma palabra. Esto desperdicia parámetros e impide la generalización entre posiciones.",
                    figLabel7: "Interactivo · Motivación para Compartir Parámetros",
                    figHint7: "Compara MLP (pesos separados por posición) vs un modelo hipotético con pesos compartidos. Ve cuánto más eficiente sería compartir.",
                    p7: "Las cinco limitaciones comparten un origen común: el MLP trata todo su contexto como un solo vector plano. No tiene mecanismo para razonar sobre la estructura, el orden o la importancia relativa de tokens individuales. ¿Cómo sería la arquitectura ideal?",
                    ...
                    takeaway: "La ventana de contexto fija del MLP, los pesos dependientes de posición y la falta de compartición de parámetros son restricciones arquitectónicas duras. Superarlas requiere enfoques fundamentalmente diferentes: procesar secuencias paso a paso, compartir pesos entre posiciones y atender selectivamente al contexto relevante. Estas son exactamente las ideas detrás de las RNNs y los Transformers.",
                },
                s09: {
                    heading: "Lo Que Construimos: El Lugar del MLP en la Historia",
                    lead: "Demos un paso atrás y veamos cuánto hemos avanzado — de tablas de conteo a representaciones aprendidas. El MLP marca un punto de inflexión en la historia del modelado del lenguaje.",
                    p1: "Compara cada modelo que hemos construido, lado a lado. Desde el simple bigrama hasta el MLP completo con embeddings — cada paso añadió algo esencial.",
                    figLabel1: "Interactivo · Comparación de Evolución de Modelos",
                    figHint1: "Cambia entre Bigrama, N-grama, Red Neuronal y MLP+Embeddings. Compara pérdida, parámetros, calidad de muestra, fortalezas y debilidades.",
                    p2: "Ve la diferencia de calidad en el texto generado. La misma semilla produce resultados muy diferentes dependiendo de la arquitectura y entrenamiento del modelo.",
                    figLabel2: "Interactivo · Galería de Generación",
                    figHint2: "Selecciona una semilla y compara la generación de texto lado a lado de los cuatro tipos de modelo. Observa cómo mejora la calidad con cada avance arquitectónico.",
                    p3: "El MLP no apareció de forma aislada. Se sitúa al comienzo de una trayectoria notable de innovación arquitectónica, desde la memoria secuencial hasta la atención y la revolución Transformer.",
                    figLabel3: "Interactivo · Línea Temporal Histórica",
                    figHint3: "De Bengio 2003 a GPT — ve dónde encaja el MLP en la historia del modelado del lenguaje.",
                    p4: "Los límites estructurales que exploraste señalan naturalmente hacia la siguiente arquitectura:",
    ...
    bigramNarrative: {
        ...
        coreIdea: {
            ...
            formalTitle: "Más profundo: ¿De dónde viene el nombre?",
            formalP1: "El prefijo 'bi-' significa dos, y '-grama' viene del griego gramma (letra). Un bigrama es literalmente una unidad de dos letras. En NLP, el término se extiende a cualquier par de tokens consecutivos — caracteres, palabras o subpalabras.",
            formulaCaption: "Probabilidad del carácter cₙ dado el carácter anterior cₙ₋₁",
            formalP2: "En castellano llano: para predecir qué viene después de un carácter, cuenta cuántas veces ese par específico apareció en el texto de entrenamiento, y divide por cuántas veces apareció el primer carácter en total. Esa proporción es la probabilidad.",
            formalP3: "Esto es una Estimación de Máxima Verosimilitud (MLE) — la forma más simple de convertir conteos en probabilidades. Es la misma matemática detrás de los pronósticos del tiempo ('llovió 30 de 100 martes, así que P(lluvia|martes) = 30%') y los promedios de bateo. Andrey Markov formalizó este enfoque en 1913 cuando analizó las transiciones de letras en Eugene Onegin.",
        ...
        sampling: {
            ...
            softmaxTitle: "Formal: ¿Qué es Softmax?",
            softmaxP1: "La técnica que acabamos de usar — convertir conteos en una distribución de probabilidad — tiene un nombre formal: softmax. Toma cualquier lista de números (llamados logits) y los comprime en probabilidades que suman 1, preservando el orden relativo.",
        ...
        contextBlindness: {
            ...
            explanation: "El bigrama solo ve la última letra 'h'. La 't', 's' y 'w' antes de ella son completamente invisibles. Ese es el defecto fatal.",
            figureLabel: "Ceguera de Contexto",
            figureHint: "Tres contextos diferentes, tres predicciones idénticas. El modelo es ciego a todo excepto el último carácter.",
        },
        cliffhanger: {
            ...
            p1: "Pregúntale al modelo qué viene después de 'th'. No sabe nada de 't' — solo ve 'h'. Así que da exactamente la misma predicción que para 'sh' o 'wh'. El contexto antes de 'h' es invisible. Perdido para siempre.",
            memoryLabel: "Interactivo · Una Letra de Memoria",
            memoryHint: "Observa cómo el modelo está limitado a un solo carácter de contexto.",
            bridgeP1: "El límite de memoria es solo la mitad de la historia. Observa qué pasa cuando tres prefijos completamente diferentes comparten la misma última letra:",
    ...
    ngramNarrative: {
        ...
        moreContext: {
            ...
            tryPrompt: "Arrastra el selector. ¿Qué le pasa a la predicción?",
        },
        contextWindow: {
        ...
        improvement: {
            ...
            battleBridge: "Los números cuentan la historia — pero ver es creer. Abajo, la misma semilla alimenta modelos con diferentes tamaños de memoria.",
            expandableGenTitle: "Pruébalo tú: Tu propio generador N-grama",
        },
        celebration: {
            text: "Has construido un predictor mucho más potente. El 4-grama escribe frases que casi parecen inglés. Pero ¿cuál es el coste de toda esta memoria?",
        },
        whyNotMore: {
        ...
        deeperProblem: {
            ...
            demoBridge: "Estos no son casos extremos — son situaciones cotidianas. Expande las secciones de abajo para ver cómo los errores tipográficos y la similitud de palabras rompen el modelo de formas diferentes.",
    ...
    neuralNetworkNarrative: {
        ...
        fromNumbers: {
            ...
            mlpBridge: "Para arreglar esto, necesitamos dos cosas: más contexto y una forma más inteligente de representar caracteres. Más contexto significa mirar 2, 3 o más caracteres anteriores en lugar de solo uno. Representaciones más inteligentes significa aprender qué tienen en común los caracteres — para que 'a' y 'e' se reconozcan como vocales similares, no como símbolos sin relación. El capítulo MLP resuelve ambos problemas.",
